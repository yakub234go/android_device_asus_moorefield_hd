...
TARGET_RELEASETOOLS_EXTENSIONS := device/asus/moorefield/hd

TARGET_BOARD_PLATFORM := moorefield
TARGET_BOOTLOADER_BOARD_NAME := moorefield
TARGET_USERIMAGES_USE_EXT4 := true

TARGET_SPECIFIC_HEADER_PATH := device/asus/moorefield/hd/include
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/asus/moorefield/hd/bluetooth
...
BOARD_EGL_CFG := device/asus/moorefield/hd/configs/egl.cfg
...
BOARD_SEPOLICY_DIRS := device/asus/moorefield/hd/sepolicy
...
# Use the non-open-source parts, if they're present
-include vendor/asus/moorefield/hd/BoardConfigVendor.mk
